---
permalink: /scenarios/scenario-68/
title: Scenario 68
subtitle: ''    
---
...
<table cellpadding="1">
    ...
    <tr>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E68-level0.mp4" type="video/mp4"></video>
            </center>
        </td>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E68-level1.mp4" type="video/mp4"></video>
            </center>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E68-level2.mp4" type="video/mp4"></video>
            </center>
        </td>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E68-level3.mp4" type="video/mp4"></video>
            </center>
        </td>
    </tr>
</table>
