---
permalink: /scenarios/scenario-56/
title: Scenario 56
subtitle: ''    
---
...
<table cellpadding="1">
    ...
    <tr>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E56-level0.mp4" type="video/mp4"></video>
            </center>
        </td>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E56-level1.mp4" type="video/mp4"></video>
            </center>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E56-level2.mp4" type="video/mp4"></video>
            </center>
        </td>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E56-level3.mp4" type="video/mp4"></video>
            </center>
        </td>
    </tr>
</table>
