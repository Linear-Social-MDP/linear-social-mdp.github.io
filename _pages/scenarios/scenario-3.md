---
permalink: /scenarios/scenario-3/
title: Scenario 3
subtitle: ''    
---
...
<table cellpadding="1">
    ...
    <tr>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E3-level0.mp4" type="video/mp4"></video>
            </center>
        </td>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E3-level1.mp4" type="video/mp4"></video>
            </center>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E3-level2.mp4" type="video/mp4"></video>
            </center>
        </td>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E3-level3.mp4" type="video/mp4"></video>
            </center>
        </td>
    </tr>
</table>
