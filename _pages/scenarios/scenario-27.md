---
permalink: /scenarios/scenario-27/
title: Scenario 27
subtitle: ''    
---
...
<table cellpadding="1">
    ...
    <tr>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E27-level0.mp4" type="video/mp4"></video>
            </center>
        </td>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E27-level1.mp4" type="video/mp4"></video>
            </center>
        </td>
    </tr>
    ...
    <tr>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E27-level2.mp4" type="video/mp4"></video>
            </center>
        </td>
        <td>
            <center>
                <video width="400" height="400" controls><source src="/scenario-videos/E27-level3.mp4" type="video/mp4"></video>
            </center>
        </td>
    </tr>
</table>
